...
/*
* Adjusted imports from original: https://github.com/latitudegames/GPT-3-Encoder
*/
const encoder = JSON.parse(fs.readFileSync(path.join(__dirname, '../node_modules/gpt-3-encoder/encoder.json')));
const bpe_file = fs.readFileSync(path.join(__dirname, '../node_modules/gpt-3-encoder/vocab.bpe'), 'utf-8');
